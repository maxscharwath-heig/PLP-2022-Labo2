...
alex_table = listArray (0 :: Int, 1090)
  [ 0
  , 12
  , 12
  , 12
...
alex_check = listArray (0 :: Int, 1090)
  [ -1
  , 9
  , 10
  , 11
...
data Token = TInt Int
            ...
            | TEnd
            | TUnOp Char 
            | TBinOp Char deriving (Show, Eq)

lexer = alexScanTokens
alex_action_1 = \s -> TInt (read s)
alex_action_2 = \s -> TUnOp (head s)
alex_action_3 = \s -> TBinOp (head s)
alex_action_4 = \s -> TBool True
alex_action_5 = \s -> TBool False
alex_action_6 = \s -> TLet
alex_action_7 = \s -> TIn
alex_action_8 = \s -> TCase
alex_action_9 = \s -> TOf
alex_action_10 = \s -> TLParen
alex_action_11 = \s -> TRParen
alex_action_12 = \s -> TComma
alex_action_13 = \s -> TEnd
alex_action_14 = \s -> TIdentifier s
